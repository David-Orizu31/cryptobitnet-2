                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="custom_images">
                            <ul class="footer-social data-lists">
                                ...
                                <li class="instagram-fs data-links"><a href="https://www.instagram.com/CryptoBitNet_official" target="_blank" rel="noreferrer" style="margin-right: 20px !important;"><svg class="gm-icon gm-icon-instagram"><use xlink:href="img/sprite.svg#gm-icon-instagram"></use></svg><img src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAUAAAAFCAYAAACNbyblAAAAGXRFWHRTb2Z0d2FyZQBBZG9iZSBJbWFnZVJlYWR5ccllPAAAABdJREFUeNpi/P//PwM6YGLAAigUBAgwADZQAwcsn51XAAAAAElFTkSuQmCC" alt="Share to Instagram" /></a></li>
                                <li class="twitter-fs data-links"><a href="#" target="_blank" rel="noreferrer"><svg class="gm-icon gm-icon-twitter"><use xlink:href="img/sprite.svg#gm-icon-twitter"></use></svg><img src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAUAAAAFCAYAAACNbyblAAAAGXRFWHRTb2Z0d2FyZQBBZG9iZSBJbWFnZVJlYWR5ccllPAAAABdJREFUeNpi/P//PwM6YGLAAigUBAgwADZQAwcsn51XAAAAAElFTkSuQmCC" alt="Share to Twitter" /></a></li>
                                                    </ul>
                        </div>
