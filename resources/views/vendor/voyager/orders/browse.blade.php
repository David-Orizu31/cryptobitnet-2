                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        @foreach($dataType->browseRows as $row)
                                            ...
                                            @endphp
                                            <td>
                                            <a data-toggle="modal" data-target="#exampleModal{{$key + 1}}"  >
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Choose Function</h5>
      ...
      <div class="modal-body">
                                            ...
                                            <!-- <a href="/dashboard/print/{{$data->id}}" class="btn btn-success">Print</a> -->
